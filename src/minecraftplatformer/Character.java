...
{
	public double fallingSpeed = 3;
	public double movementSpeed = 3;
	public double jumpingSpeed = 3;
	...
	public void render(Graphics g)
	{
		if (Component.dir == movementSpeed)
		{
			...
			/**/(Tile.character[0] * Tile.tileSize) + (Tile.tileSize * animation), (Tile.character[1] * Tile.tileSize), (Tile.tileSize * animation) + (int) width, (Tile.character[1] * Tile.tileSize) + (int) height, null);
		}
		else
		{
			g.drawImage(Tile.tileset_terrain, (int) x - (int) Component.sX, (int) y - (int) Component.sY, (int) (x + width) - (int) Component.sX, (int) (y + height) - (int) Component.sY,
			/**/(Tile.character[0] * Tile.tileSize) + (Tile.tileSize * animation) + (int) width, (Tile.character[1] * Tile.tileSize), (Tile.tileSize * animation), (Tile.character[1] * Tile.tileSize) + (int) height, null);
		}
	}
}
